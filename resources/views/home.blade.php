...
<body>
  <div class="navbar1">
    ...
    <div class="navbar3">
    <ul>
        <li><a href="https://web.facebook.com/"><img src="img/facebook-24.png" alt=""></a></li>
        <li><a href="https://twitter.com/"><img src="img/twitter-24.png" alt=""></a></li>
    ...
    <ul>
        ...
        <li><a href=""><img src="img/cart-70-24.png" alt=""></a></li>
    </ul>
    <ul>
        <li><a href=""><img src="img/search-3-24.png" alt=""></a></li>
    </ul>
    </div>
...
<div class="p-subs">
    ...
    <div class="subs1 col-6 mt-2">
      ...
      <div class="d-flex col-6 align-items-center">
        ...
        <button class="btn btn-primary" style="background-color: #fa6161" type="button">Subscribe</button>
      </div>
    </form>
  </div>
</div>
...
<!-- footer -->
<div class="container-fluid bg-custom-black">
